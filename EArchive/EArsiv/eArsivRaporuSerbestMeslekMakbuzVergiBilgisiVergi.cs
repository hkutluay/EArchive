...
public partial class eArsivRaporuSerbestMeslekMakbuzVergiBilgisiVergi
{
    private decimal matrahField;
    private eArsivRaporuSerbestMeslekMakbuzVergiBilgisiVergiVergiKodu vergiKoduField;
    ...
    public eArsivRaporuSerbestMeslekMakbuzVergiBilgisiVergiVergiKodu vergiKodu
    {
        get
        {
